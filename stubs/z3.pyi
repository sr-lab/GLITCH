...
class ArithRef(ExprRef):
    def __ge__(self, __value: object) -> BoolRef: # type: ignore
        ...
...
class Solver:
    def __init__(self, solver: Solver | None = None, ctx: Context | None = None, logFile: str | None = None) -> None:
        ...
...
def If(a: Probe | Z3PPObject, b: Z3PPObject, c: Z3PPObject, ctx: Context | None = None) -> ExprRef:
    ...
